...
updateSurveyCode(local="WriteUp/Rcode/surveyCode",save=F)
...
spb2014 <- base$mcmc[,grep("SPB",names(base$mcmc))]/2e6
spb2014 <- spb2014[,-match(c("SPB_Virgin","SPB_2015","SPB_2016"),names(spb2014))]
slower <- apply(spb2014,2,quantile,prob=0.025)   #hard-wired probability
smed   <- apply(spb2014,2,quantile,prob=0.5)   #hard-wired probability
supper <- apply(spb2014,2,quantile,prob=0.975)   #hard-wired probability

depl2014 <- t(apply(spb2014,1,function(x){x/x[1]}))[,-1]
dlower <- apply(depl2014,2,quantile,prob=0.025)   #hard-wired probability
dmed   <- apply(depl2014,2,quantile,prob=0.5)   #hard-wired probability
dupper <- apply(depl2014,2,quantile,prob=0.975)   #hard-wired probability

recr2014 <- base$mcmc[,grep("Recr_",names(base$mcmc))]/1e6
recr2014 <- recr2014[,-grep("Fore",names(recr2014))]
yrs <- unlist(lapply(strsplit(names(recr2014),"_"),function(x){x[2]}))
recr2014 <- recr2014[,yrs%in%c("Virgin",1966:2014)]
yrs <- as.numeric(unlist(lapply(strsplit(names(recr2014),"_"),function(x){x[2]})))
rmed   <- apply(recr2014,2,quantile,prob=0.5)   #hard-wired probability
rmean   <- apply(recr2014,2,mean)   #hard-wired probability
rlower <- apply(recr2014,2,quantile,prob=0.025)   #hard-wired probability
rupper <- apply(recr2014,2,quantile,prob=0.975)   #hard-wired probability
...
pdf("c:/NOAA2014/Hake/WriteUp/Figures/catches.pdf",height=ht,width=wd)
...
ht <- 3.75; wd<- 6.5
if(doPNG) {png("Writeup/Figures/biomass.png",height=ht,width=wd,pointsize=10,units="in",res=300)}
if(!doPNG) {windows(width=wd,height=ht)}
yrs <- 1964:2014
par(mfrow=c(1,1),las=1,mar=c(3.5,3.5,1,1))
plot(yrs[-c(1,2)],c(smed[2:length(smed)]),type="l",lwd=3,ylim=c(0,max(supper)+0.1),xlab="Year",ylab="Female Spawning Biomass (million mt)",xlim=range(yrs),cex.axis=0.9,cex.lab=1,mgp=c(2.3,1,0),yaxs="i")
points(yrs[1],smed[1],pch=16)
arrows(yrs[1],slower[1],yrs[1],supper[1],angle=90,code=3,length=0.06)
legend("bottomleft","Unfished equilibrium spawning biomass",pch=20,bty="n",cex=0.9)
addpoly(yrs[-c(1,2)],slower[-1],supper[-1],"black")
if(doPNG) {dev.off()}

ht <- 3.75; wd<- 6.5
if(doPNG) {png("Writeup/Figures/biomassColor.png",height=ht,width=wd,pointsize=10,units="in",res=300)}
if(!doPNG) {windows(width=wd,height=ht)}
yrs <- 1964:2014
par(mfrow=c(1,1),las=1,mar=c(3.5,3.5,1,1))
plot(yrs[-c(1,2)],c(smed[2:length(smed)]),type="l",lwd=3,ylim=c(0,max(supper)+0.1),xlab="Year",ylab="Female Spawning Biomass (million mt)",xlim=range(yrs),cex.axis=0.9,cex.lab=1,mgp=c(2.3,1,0),yaxs="i")
...
legend("topleft","Unfished equilibrium spawning biomass",pch=20,bty="n")
...
ht <- 3.75; wd<- 6.5
if(doPNG) {png("Writeup/Figures/depletion.png",height=ht,width=wd,pointsize=10,units="in",res=300)}
if(!doPNG) {windows(width=wd,height=ht)}
par(mfrow=c(1,1),las=1,mar=c(3.5,3.5,1,1))
yrs <- 1966:2014
plot(yrs,dmed,type="l",lwd=3,ylim=c(0,max(dupper)),xlab="Year",ylab="Depletion",xlim=range(yrs),cex.axis=0.9,cex.lab=1,mgp=c(2.3,1,0),yaxs="i")
...
ht <- 3.75; wd<- 6.5
if(doPNG) {png("Writeup/Figures/depletionColor.png",height=ht,width=wd,pointsize=10,units="in",res=300)}
if(!doPNG) {windows(width=wd,height=ht)}
par(mfrow=c(1,1),las=1,mar=c(3.5,3.5,1,1))
yrs <- 1966:2014
plot(yrs,dmed,type="l",lwd=3,ylim=c(0,max(dupper)),xlab="Year",ylab="Depletion",xlim=range(yrs),cex.axis=0.9,cex.lab=1,mgp=c(2.3,1,0),yaxs="i")
...
ht <- 3.25; wd<- 6.5
yrs <- 1964:2014
if(doPNG) {png("Writeup/Figures/recruitment.png",height=ht,width=wd,pointsize=10,units="in",res=300)}
if(!doPNG) {windows(width=wd,height=ht)}
...
axis(1,at=seq(1965,2013,5))
abline(h=0,col=rgb(0,0,0,0.5))
if(doPNG){dev.off()}

ht <- 3.25; wd<- 6.5
yrs <- 1964:2014
if(doPNG) {png("Writeup/Figures/recruitmentWithMean.png",height=ht,width=wd,pointsize=10,units="in",res=300)}
if(!doPNG) {windows(width=wd,height=ht)}
par(mfrow=c(1,1),las=1,mar=c(3.5,3.5,1,1),oma=c(0,0,0,0))
plotBars.fn(yrs[-c(1,2)],y,scalar=1,ylim=c(0,30),pch=20,xlab="Year",ylab="Age 0 recruits (billions)",cex=0.8,las=1,gap=0,xaxt="n",ciLwd=1,ciCol=rgb(0,0,1,0.5),mgp=c(2.3,1,0),xlim=range(yrs[-c(1,2)]))
...
#legend("topleft","Unfished equilibrium recruitment",pch=4,bty="n")
axis(1,at=seq(1965,2013,5))
axis(2,at=rmed[1],label=expression(R[0]),cex.axis=0.6,mgp=c(1,0.3,0),tcl=-0.2)
abline(h=0,col=rgb(0,0,0,0.5))
arrows(2010,30.9,2010,31,length=0.05,col=rgb(0,0,1,0.5))
if(doPNG){dev.off()}

#Fishing Intensity
spr2014 <- base$mcmc[,grep("SPRratio_",names(base$mcmc))]
yrs <- unlist(lapply(strsplit(names(spr2014),"_"),function(x){x[2]}))
spr2014 <- spr2014[,yrs%in%c(1966:2013)]
yrs <- as.numeric(unlist(lapply(strsplit(names(spr2014),"_"),function(x){x[2]})))
pmed   <- apply(spr2014,2,quantile,prob=0.5)   #hard-wired probability
plower <- apply(spr2014,2,quantile,prob=0.025)   #hard-wired probability
pupper <- apply(spr2014,2,quantile,prob=0.975)   #hard-wired probability

y <- data.frame(value=pmed,lo=plower,hi=pupper)

ht <- 3.25; wd<- 6.5
yrs <- 1966:2013
if(doPNG) {png("Writeup/Figures/SPRratio.png",height=ht,width=wd,pointsize=10,units="in",res=300)}
if(!doPNG) {windows(width=wd,height=ht)}
par(mfrow=c(1,1),las=1,mar=c(3.5,3.5,1,1),oma=c(0,0,0,0))
plotBars.fn(yrs,y,scalar=1,ylim=c(0,1.3),pch=20,xlab="Year",ylab="Fishing intensity (1-SPR)/(1-SPR_40%)",cex=0.8,las=1,gap=0.02,xaxt="n",ciLwd=1,ciCol=rgb(0,0,1,0.5),mgp=c(2.3,1,0),xlim=range(yrs),yaxs="i")
#axis(1,at=seq(1965,2013,5))
axis(1,at=seq(1965,2013,2))
...
f2014 <- f2014[,yrs%in%c(1966:2013)]
...
ht <- 3.25; wd<- 6.5
yrs <- 1966:2013
if(doPNG) {png("Writeup/Figures/ExpRate.png",height=ht,width=wd,pointsize=10,units="in",res=300)}
if(!doPNG) {windows(width=wd,height=ht)}
par(mfrow=c(1,1),las=1,mar=c(3.5,3.5,1,1),oma=c(0,0,0,0))
plotBars.fn(yrs,y,scalar=1,ylim=c(0,0.5),pch=20,xlab="Year",ylab="Exploitation fraction",cex=0.8,las=1,gap=0.005,xaxt="n",ciLwd=1,ciCol=rgb(0,0,1,0.5),mgp=c(2.3,1,0),xlim=range(yrs),yaxs="i")
axis(1,at=seq(1965,2013,2))
if(doPNG){dev.off()}
...
sb <- smed[yrs%in%c(1966:2013)]/sb0
sb.hi <- supper[yrs%in% 2013]/sb0
sb.lo <- slower[yrs%in% 2013]/sb0
yrs <- unlist(lapply(strsplit(names(pmed),"_"),function(x){x[2]}))
spr <- pmed[yrs%in%c(1966:2013)]
spr.hi <- pupper[yrs%in% 2013]
spr.lo <- plower[yrs%in% 2013]

ht <- 4; wd<- 6.5
if(doPNG) {png("Writeup/Figures/phasePlot.png",height=ht,width=wd,pointsize=10,units="in",res=300)}
if(!doPNG) {windows(width=wd,height=ht)}
par(mfrow=c(1,1),las=1,mar=c(3.6,3.6,1,1),oma=c(0,0,0,0))
plot(sb,spr,type="p",pch=20,xlim=c(0,1.3),ylim=c(0,1.3),xlab="Spawning depletion (SB/SB0)",ylab="Relative fishing intensity (1-SPR)/(1-SPR_40%)",xaxs="i",yaxs="i",mgp=c(2.4,1,0))
arrows(sb[-length(sb)],spr[-length(spr)],sb[-1],spr[-1],length=0.09,col=rgb(0,0,0,0.4))
points(sb[length(sb)],spr[length(spr)],pch=16,col=rgb(0,0,1,0.8),cex=1.2)
points(sb[1],spr[1],pch=16,col=rgb(0,0,0.8,0.4),cex=1.2)
text(sb[1],spr[1]-0.025,"1966",cex=0.6,pos=2,offset=0.15)
segments(sb[length(sb)],spr.lo,sb[length(sb)],spr.hi,col=rgb(0,0,1,0.8))
segments(sb.lo,spr[length(spr)],sb.hi,spr[length(spr)],col=rgb(0,0,1,0.8))
text(sb[length(sb)],spr[length(spr)]+0.045,"2013",pos=4,cex=0.6)
...
doPNG <- T
mymodels <- list(base,base,base,base); modelnames <- c("Default: 872,424 mt","Stable Catch: 727,000 mt","375,000 mt","No Fishing")
mysummary <- SSsummarize(mymodels)
mysummary$mcmc <- tmp
ht <- 3.25; wd<- 6.5
if(doPNG) {png("Writeup/Figures/forecasts.png",height=ht,width=wd,pointsize=10,units="in",res=300)}
if(!doPNG) {windows(width=wd,height=ht)} 
par(mar=c(4.5,4,1,1))
SSplotComparisons(mysummary, legendlabels=modelnames,endyr=2016,densitynames=c("Bratio_2013"),new=F,minbthresh=0,subplots=4,plot=T,mcmc=rep(T,4),xlim=c(2005,2016),legendloc="topleft",
        labels=c("Year","Spawning biomass (mt)","Spawning depletion","Age-0 recruits (1,000s)","Recruitment deviations","Index",
...
doPNG <- T
ht <- 3.75; wd<- 6.5
if(doPNG) {png("Writeup/Figures/metrics2015.png",height=ht,width=wd,pointsize=10,units="in",res=300)}
if(!doPNG) {windows(width=wd,height=ht)}
par(mfrow=c(1,1),las=1,mar=c(3.6,3.6,1,1),oma=c(0,0,0,0),mgp=c(2.5,1,0))
plot(metrics$Catch,metrics[,2],ylim=c(0,1),xaxt="n",ylab="Probability",xlab="Catch in 2014 ('000 mt)",type="b",lty=2,pch=16)
...
doPNG <- T
ht <- 3.75; wd<- 6.5
if(doPNG) {png("Writeup/Figures/metrics2016.png",height=ht,width=wd,pointsize=10,units="in",res=300)}
if(!doPNG) {windows(width=wd,height=ht)}
par(mfrow=c(1,1),las=1,mar=c(3.6,3.6,1,1),oma=c(0,0,0,0),mgp=c(2.5,1,0))
plot(metrics$Catch,metrics[,2],ylim=c(0,1),xaxt="n",ylab="Probability",xlab="Catch in 2015 ('000 mt)",type="b",lty=2,pch=16)
lines(metrics$Catch,metrics[,3],col="blue",type="b",lty=2,pch=17)
lines(metrics$Catch,metrics[,4],col="green",type="b",lty=2,pch=17)
lines(metrics$Catch,metrics[,5],col="orange",type="b",lty=2,pch=17)
lines(metrics$Catch,metrics[,6],col="red",type="b",lty=2,pch=15)
...
ht <- 4; wd<- 6.5
if(doPNG) {png("Writeup/Figures/data.png",height=ht,width=wd,pointsize=10,units="in",res=300)}
if(!doPNG) {windows(width=wd,height=ht)}
par(mfrow=c(1,1),las=1,mar=c(3.6,3.6,1,1),oma=c(0,0,0,0))
...
doPNG <- T
ht <- 4; wd<- 6.5
if(doPNG) {png("Writeup/Figures/percSeasCatch.png",height=ht,width=wd,pointsize=10,units="in",res=300)}
if(!doPNG) {windows(width=wd,height=ht)}
...
doPNG <- T
ht <- 4; wd<- 6.5
if(doPNG) {png("Writeup/Figures/age1Index.png",height=ht,width=wd,pointsize=10,units="in",res=300)}
if(!doPNG) {windows(width=wd,height=ht)}
...
doPNG <- T
ht <- 4; wd<- 6.5
if(doPNG) {png("Writeup/Figures/age1IndexWithRecr.png",height=ht,width=wd,pointsize=10,units="in",res=300)}
if(!doPNG) {windows(width=wd,height=ht)}
par(mar=c(3, 4, 1, 1) + 0.1)
x <- read.csv("Data/AcousticSurvey/Age1Index.csv")
...
modelnames <- c("Base")
ht <- 3.5; wd<- 6.5
if(doPNG) {png("Writeup/Figures/fitIndex.png",height=ht,width=wd,pointsize=10,units="in",res=300)}
if(!doPNG) {windows(width=wd,height=ht)}
...
##
ht <- 5; wd<- 5
if(doPNG) {png("Writeup/Figures/plotPars.png",height=ht,width=wd,pointsize=10,units="in",res=300)}
if(!doPNG) {windows(width=wd,height=ht)}
...
ht <- 3.25; wd<- 6.5
if(doPNG) {png("Writeup/Figures/MLEvsMCMC_depl.png",height=ht,width=wd,pointsize=10,units="in",res=300)}
if(!doPNG) {windows(width=wd,height=ht)}
par(mfrow=c(1,1),las=1,mar=c(3.6,3.6,1,1),oma=c(0,0,0,0),mgp=c(2.5,1,0))
...
ht <- 3.25; wd<- 6.5
if(doPNG) {png("Writeup/Figures/MLEvsMCMC_spb.png",height=ht,width=wd,pointsize=10,units="in",res=300)}
if(!doPNG) {windows(width=wd,height=ht)}
par(mfrow=c(1,1),las=1,mar=c(3.6,3.6,1,1),oma=c(0,0,0,0),mgp=c(2.5,1,0))
...
ht <- 3.25; wd<- 6.5
if(doPNG) {png("Writeup/Figures/MLEvsMCMC_recr.png",height=ht,width=wd,pointsize=10,units="in",res=300)}
if(!doPNG) {windows(width=wd,height=ht)}
par(mfrow=c(1,1),las=1,mar=c(3.6,3.6,1,1),oma=c(0,0,0,0),mgp=c(2.5,1,0))
...
ht <- 3; wd<- 6.5
if(doPNG) {png("Writeup/Figures/catch2014.png",height=ht,width=wd,pointsize=10,units="in",res=300)}
if(!doPNG) {windows(width=wd,height=ht)}
...
plot(y,yaxt="n",ylab="Density",xlab="Projected 2014 catch based on the default harvest policy ('000 mt)",type="l",lty=1,pch=16,xlim=c(0,2500),xaxs="i",yaxs="i",ylim=c(0,max(y$y)*1.02),lwd=3,main="",xaxt="n")
...
ht <- 3.25; wd<- 6.5
if(doPNG) {png("Writeup/Figures/sens.25.31_depl.png",height=ht,width=wd,pointsize=10,units="in",res=300)}
if(!doPNG) {windows(width=wd,height=ht)}
par(mfrow=c(1,1),las=1,mar=c(3.6,3.6,1,1),oma=c(0,0,0,0),mgp=c(2.5,1,0))
...
ht <- 3.25; wd<- 6.5
if(doPNG) {png("Writeup/Figures/sens.25.31_spb.png",height=ht,width=wd,pointsize=10,units="in",res=300)}
if(!doPNG) {windows(width=wd,height=ht)}
par(mfrow=c(1,1),las=1,mar=c(3.6,3.6,1,1),oma=c(0,0,0,0),mgp=c(2.5,1,0))
...
ht <- 3.25; wd<- 6.5
if(doPNG) {png("Writeup/Figures/sens.25.31_recr.png",height=ht,width=wd,pointsize=10,units="in",res=300)}
if(!doPNG) {windows(width=wd,height=ht)}
par(mfrow=c(1,1),las=1,mar=c(3.6,3.6,1,1),oma=c(0,0,0,0),mgp=c(2.5,1,0))
...
retro <- retro[retro$Value=="SB million mt",]
...
years <- as.numeric(substring(names(retro[yearInd]),2))
plot(range(years),range(retro[,yearInd],na.rm=T),type="n",xlab="Year",ylab="Spawning Biomass (million mt)",las=1,xlim=c(min(years),max(years)),cex.axis=0.9,cex.lab=1)
...
doPNG <- T
ht <- 3.25; wd<- 6.5
if(doPNG) {png("Writeup/Figures/Retros/retro21_depl.png",height=ht,width=wd,pointsize=10,units="in",res=300)}
if(!doPNG) {windows(width=wd,height=ht)}
par(mfrow=c(1,1),las=1,mar=c(3.6,3.6,1,1),oma=c(0,0,0,0),mgp=c(2.5,1,0))
...
doPNG <- T
ht <- 3.25; wd<- 6.5
if(doPNG) {png("Writeup/Figures/Retros/retro21_recr.png",height=ht,width=wd,pointsize=10,units="in",res=300)}
if(!doPNG) {windows(width=wd,height=ht)}
par(mfrow=c(1,1),las=1,mar=c(3.6,3.6,1,1),oma=c(0,0,0,0),mgp=c(2.5,1,0))
...
pdf("Writeup/Figures/Retros/25_retros.pdf")
SSplotComparisons(mysummary, legendlabels=modelnames,endyr=2014-(13:0),new=F,minbthresh = 0,
                densitynames = c("SPB_Virgin","R0","NatM_p_1_Fem_GP_1","SR_BH_steep","Recr_2008","Recr_2009","Recr_2010","Recr_2011"),mcmc=rep(T,14))
#plot and compare selex
columns <- 1:9
...
doPNG <- T
ht <- 3.25; wd<- 6.5
if(doPNG) {png("Writeup/Figures/Retros/retro05_depl_5yrFore_1.png",height=ht,width=wd,pointsize=10,units="in",res=300)}
if(!doPNG) {windows(width=wd,height=ht)}
par(mfrow=c(1,1),las=1,mar=c(3.6,3.6,1,1),oma=c(0,0,0,0),mgp=c(2.5,1,0))
...
doPNG <- T
ht <- 3.25; wd<- 6.5
if(doPNG) {png("Writeup/Figures/Retros/retro05_depl_5yrFore_2.png",height=ht,width=wd,pointsize=10,units="in",res=300)}
if(!doPNG) {windows(width=wd,height=ht)}
par(mfrow=c(1,1),las=1,mar=c(3.6,3.6,1,1),oma=c(0,0,0,0),mgp=c(2.5,1,0))
...
doPNG <- T
ht <- 3.25; wd<- 6.5
if(doPNG) {png("Writeup/Figures/Retros/retro05_depl_5yrFore.png",height=ht,width=wd,pointsize=10,units="in",res=300)}
if(!doPNG) {windows(width=wd,height=ht)}
par(mfrow=c(1,1),las=1,mar=c(3.6,3.6,1,1),oma=c(0,0,0,0),mgp=c(2.5,1,0))
...
axis(2,at=c(0.1,0.4),cex.axis=0.7)
if(doPNG) {dev.off()}
if(doPNG) {png("Writeup/Figures/Retros/retro05_catch_5yrFore.png",height=ht,width=wd,pointsize=10,units="in",res=300)}
if(!doPNG) {windows(width=wd,height=ht)}
par(mfrow=c(1,1),las=1,mar=c(3.6,3.6,1,1),oma=c(0,0,0,0),mgp=c(2.5,1,0))
...
doPNG <- T
ht <- 3.25; wd<- 6.5
if(doPNG) {png("Writeup/Figures/Retros/retro10_depl_10yrFore.png",height=ht,width=wd,pointsize=10,units="in",res=300)}
if(!doPNG) {windows(width=wd,height=ht)}
par(mfrow=c(1,1),las=1,mar=c(3.6,3.6,1,1),oma=c(0,0,0,0),mgp=c(2.5,1,0))
...
axis(2,at=c(0.1,0.4),cex.axis=0.7)
if(doPNG) {dev.off()}
if(doPNG) {png("Writeup/Figures/Retros/retro10_catch_10yrFore.png",height=ht,width=wd,pointsize=10,units="in",res=300)}
if(!doPNG) {windows(width=wd,height=ht)}
par(mfrow=c(1,1),las=1,mar=c(3.6,3.6,1,1),oma=c(0,0,0,0),mgp=c(2.5,1,0))
SSplotComparisons(mysummary,legendlabels=modelnames,endyr=c(2014,2014),new=F,minbthresh=0,subplot=14,legend=T,btarg=-0.4,mcmc=c(T,T),legendloc="topright",
                    densitynames=c("ForeCatch_2014"))
...
modelnames <- c("Survey 1.8mmt","base 2014")
mysummary <- SSsummarize(mymodels)
mysummary$mcmc <- 
doPNG <- F
ht <- 3.25; wd<- 6.5
if(doPNG) {png("Writeup/Figures/Sensitivities/run1.2_foreCatch.png",height=ht,width=wd,pointsize=10,units="in",res=300)}
if(!doPNG) {windows(width=wd,height=ht)}
par(mfrow=c(1,1),las=1,mar=c(3.6,3,1,1),oma=c(0,0,0,0),mgp=c(2.5,1,0))
SSplotComparisons(mysummary,legendlabels=modelnames,endyr=c(2014,2014),new=F,minbthresh=0,subplot=14,legend=T,btarg=-0.4,mcmc=c(T,T),legendloc="topright",
                    densitynames=c("ForeCatch_2014"),densityxlabs="Default harvest catch in 2014 (thousands mt)",
                    labels=c("Year","Spawning biomass (mt)","Spawning depletion","Age-0 recruits (1,000s)","Recruitment deviations","Index",
...
doPNG <- T
ht <- 3.25; wd<- 6.5
if(doPNG) {png("Writeup/Figures/Sensitivities/run1.2_depl.png",height=ht,width=wd,pointsize=10,units="in",res=300)}
if(!doPNG) {windows(width=wd,height=ht)}
par(mfrow=c(1,1),las=1,mar=c(3.6,3.6,1,1),oma=c(0,0,0,0),mgp=c(2.5,1,0))
...
modelnames <- c("1.8mmt","base 2014")
mysummary <- SSsummarize(mymodels)
mysummary$mcmc <- list(run32$mcmc,base$mcmc)

doPNG <- T
ht <- 3.25; wd<- 6.5
if(doPNG) {png("Writeup/Figures/run32_depl.png",height=ht,width=wd,pointsize=10,units="in",res=300)}
if(!doPNG) {windows(width=wd,height=ht)}
par(mfrow=c(1,1),las=1,mar=c(3.6,3.6,1,1),oma=c(0,0,0,0),mgp=c(2.5,1,0))
SSplotComparisons(mysummary,legendlabels=modelnames,endyr=c(2014,2014),new=F,minbthresh=0,subplots=4,legend=T,btarg=-0.4,mcmc=c(T,T),legendloc="topleft",xlim=c(1966,2014))
...
axis(2,at=c(0.1,0.4),cex.axis=0.7)
if(doPNG) {dev.off()}
if(doPNG) {png("Writeup/Figures/run32_catch.png",height=ht,width=wd,pointsize=10,units="in",res=300)}
if(!doPNG) {windows(width=wd,height=ht)}
par(mfrow=c(1,1),las=1,mar=c(3.6,3.6,1,1),oma=c(0,0,0,0),mgp=c(2.5,1,0))
SSplotComparisons(mysummary,legendlabels=modelnames,endyr=c(2014,2014),new=F,minbthresh=0,subplot=14,legend=T,btarg=-0.4,mcmc=c(T,T),legendloc="topright",
                    densitynames=c("ForeCatch_2014"),densityxlabs="Default harvest catch in 2014 (thousands mt)",
