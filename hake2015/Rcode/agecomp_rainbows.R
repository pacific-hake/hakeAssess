# code based on Jim Ianelli's plotting of age compositions color coded by cohort
# which was inspired by (or created by?) Trevor Branch
# Ianelli's code is stored on Ian's laptop in c:/SS/Ianelli/AM_AgeFits.R

AgeFits <- function(dat=base, case_label="", f=1,
                    ncol=3,start.color=1,
