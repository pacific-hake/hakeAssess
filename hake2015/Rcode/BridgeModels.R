...
hake2015.base <- SS_output(dir=paste(SSdir,"2015hake_basePreSRG",sep="/"),covar=T,verbose=F,ncols=43)
...
dev.off()
#For document
SSplotComparisons(mysummary, legendlabels=modelnames,endyr=2015,png=T,plotdir="C:/NOAA2015/Hake/WriteUp/Figures/Bridge")
...
#Bridge to 2015 base
mymodels <- list(hake2014.04,hake2015.base)
modelnames <- c("Update 2013 data","Add 2014 data")
mysummary <- SSsummarize(mymodels)
#For document
SSplotComparisons(mysummary, legendlabels=modelnames,endyr=2015,png=T,plotdir="C:/NOAA2015/Hake/WriteUp/Figures/BridgeToBase")
